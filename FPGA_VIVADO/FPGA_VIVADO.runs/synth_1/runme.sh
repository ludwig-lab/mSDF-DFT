...
HD_PWD='C:/CodeRepos/mSDFDFT/FPGA_VIVADO/FPGA_VIVADO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFT_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFT_top.tcl
