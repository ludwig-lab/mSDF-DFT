...
HD_PWD='C:/CodeRepos/mSDFDFT/FPGA_VIVADO/FPGA_VIVADO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DFT_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DFT_top.tcl -notrace
